...
export function Halo2020() {
  return (
    <div class={[centerFlex, css({ marginTop: "20vh", fontWeight: "bold" })]}>
      <div>
        ...
        >
          Looking for the previous event? Click here
        </a>
      </div>
    </div>
  );
...
function Icon() {
  return (
    <svg viewBox="0 0 36 36" height={"30%"} width={"30%"}>
      <path
        fill="#ffcc4d"
